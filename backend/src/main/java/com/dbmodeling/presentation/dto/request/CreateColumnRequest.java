...
public class CreateColumnRequest {
    ...
    @Schema(description = "컬럼 이름", example = "user_id", required = true)
    @NotBlank(message = "컬럼 이름은 필수입니다.")
    ...
    @Schema(description = "데이터 타입", example = "BIGINT", required = true)
    ...
    @Schema(description = "컬럼 순서", example = "1", required = true)
