...
- [x] 1. 백엔드 프로젝트 구조 및 핵심 인터페이스 설정
  - Spring Boot 3.x + Java 17 프로젝트 생성 및 Clean Architecture 디렉토리 구조 설정
...
- [x] 4.2 테이블 및 컬럼 관리 유스케이스 구현
  - 테이블 생성, 수정, 삭제 비즈니스 로직 구현
