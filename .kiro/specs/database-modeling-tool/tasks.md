...
- [ ] 14.1 백엔드 누락 서비스 구현
  - ColumnService, ValidationService, ExportService 구현체 작성
  - 누락된 도메인 서비스 및 유스케이스 구현
  - 데이터베이스 설정 및 연결 구성 완성
  - _요구사항: 2.1, 4.1, 5.1_

- [ ] 14.2 프론트엔드 누락 컴포넌트 구현
  - ColumnEditor 패키지의 컴포넌트들 구현 (ColumnList, ColumnForm, DataTypeSelector)
  - 프로젝트 생성/관리 모달 및 폼 구현
  - 라우팅 및 네비게이션 완성
  - _요구사항: 2.1, 2.2, 6.1_

- [ ] 15. 통합 테스트 및 E2E 테스트 구현
