...
- [ ] 15. 데이터베이스 마이그레이션 및 초기 데이터 설정

- [ ] 15.1 Flyway 마이그레이션 스크립트 작성
...
- [ ] 17. API 연동 및 에러 처리 완성

- [ ] 17.1 API 클라이언트 완성
  - 모든 백엔드 API 엔드포인트와의 연동 완성
  - 에러 처리 및 재시도 로직 구현
  - 로딩 상태 및 에러 상태 UI 표시 완성
  - _요구사항: 모든 요구사항_

- [ ] 17.2 실시간 검증 기능 완성
  - 네이밍 규칙 실시간 검증 API 연동
  - 검증 결과 UI 표시 및 수정 제안 기능 완성
  - 검증 오류 해결 가이드 구현
